...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
    <?php if (!is_single()) { ?>
        ...
        <?php $archive_layout = magazine_prime_get_option('archive_layout'); ?>
        <?php $archive_layout_image = magazine_prime_get_option('archive_layout_image'); ?>
        ...
        <div class="entry-content twp-entry-content <?php echo esc_attr($full_width_content); ?>">
            ...
            <?php if ('full' == $archive_layout) : ?>
                ...
                /* translators: %s: Name of current post. */
                    wp_kses(__('Continue reading %s <span class="meta-nav">&rarr;</span>', 'magazine-prime'), array('span' => array('class' => array()))),

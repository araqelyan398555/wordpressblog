 ...
 */
class Magazine_Prime_Dropdown_Taxonomies_Control extends WP_Customize_Control {
 ...
 * @see WP_Customize_Control
 */
class Magazine_Prime_Radio_Image_Control extends WP_Customize_Control {
 ...
 * @access public
 */
class Magazine_Prime_Customize_Section_Upsell extends WP_Customize_Section {
